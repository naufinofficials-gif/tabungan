...
import { getUserReferrals, getUserById } from '../../lib/storage';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-slate-400">Ajak teman dan dapatkan bonus referral</p>
      </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          ...
          {referrals.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-600 text-xs mt-1">Bagikan link referral Anda untuk mulai mengajak teman</p>
            </div>
          ) : (
